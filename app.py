...
def signin ():
    ...
    if cursor.rowcount==0:
        ...
        return jsonify ({"message": "login succesfully", "user" : user})
...
def addproducts():
    ...
    cursor = connection.cursor()
    sql = """
        insert into product_details (product_name, product_description, product_category, product_cost, product_images)
        values (%s, %s, %s, %s, %s)
        """
